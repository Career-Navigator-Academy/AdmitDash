...
@v1_blueprint.route("/candidates", methods=["POST"])
def add_candidate():
...
@v1_blueprint.route("/candidates/<int:candidate_id>", methods=["GET"])
...
@v1_blueprint.route("/candidates", methods=["GET"])
def get_all():
...
@v1_blueprint.route("/candidates/<int:candidate_id>", methods=["PUT"])
...
@v1_blueprint.route("/candidates/<int:candidate_id>", methods=["DELETE"])
